    ...
    public ArrayList<Book> getBooks() {
        try {
            ...
            while (resultSet.next()) {
                /*
                #TODO:
                Supplies table must be filled
                Replace the constant URL with the URL in the table Book
                ...
                Book book = new Book(resultSet.getString("ISBN"), resultSet.getString("name"),
                        ...
                        resultSet.getString("supplier") ,resultSet.getString("description"),
                        new Image("https://cdn.britannica.com/83/78183-004-345353F4/Stack-books.jpg"), resultSet.getDouble("original_price"),
